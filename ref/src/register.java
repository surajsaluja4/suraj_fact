...
/* to make username unique :to be resoved*/

class register extends JFrame implements ActionListener
{

	  JLabel reg,name,city,state,gender,user,pass,cpass;
	  JTextField n,c,s,u,p,cp;
...
register()
{
	...
	re=new JButton("",new ImageIcon("img/Re.gif"));
	ca=new JButton("",new ImageIcon("img/Ca.gif"));

	reg.setBounds(350,20,500,100);
	reg.setFont(f9);
...
public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==re)
		{
           String name,city,user,pass,cpass,gender="Male",state;
                    ...
                    if(name.equals("")||city.equals("")||pass.equals("")||cpass.equals("")||user.equals(""))
                    {
	...
	if(con!=null)
	{
                        PreparedStatement ps=con.prepareStatement("select UserName from registration where UserName='"+user+"' ");
      ...
      PreparedStatement st=con.prepareStatement("INSERT INTO `registration`(`Name`, `City`, `Gender`, `State`, `UserName`, `Password`) VALUES (?,?,?,?,?,?)");
      st.setString(1,name);
      st.setString(2,city);
