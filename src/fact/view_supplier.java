...
class view_supplier  implements ActionListener,key
{
...
pro_list=new JComboBox();
    ...
    edit=new JLabel("View Supplier's Data");
   ...
   view.setBackground(Color.WHITE);
    ...
    p1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.BLACK,2), "View Supplier Data", TitledBorder.LEFT, TitledBorder.TOP,f9));
...
search sbm = new search(pro_list,Connection1.dbmanager_name,"product_group","name","Products");
...
search sbm1 = new search(item_list,Connection1.dbmanager_name,"product_item","prod_id","Product Items");
